...
export default class OpenAccountModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
      <Modal visible={overcoat.openAccountModal} {...modalConfig}>
        是否确认启用该账户
      </Modal>
    );
  }
  ...
  close = e => {
    ...
    this.props.dispatch({
      type: 'sadmin/manage/openAccount_modal/show/failed'
    });
  }
}

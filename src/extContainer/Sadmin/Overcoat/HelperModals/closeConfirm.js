...
export default class CloseConfirmModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    return (
      <Modal visible={overcoat.closeConfirmModal} {...modalConfig}>
      </Modal>
    );
  }
  ...
  close = e => {
    ...
    this.props.dispatch({
      type: 'sadmin/room/closeConfirm_modal/show/failed'
    });
  }
}

...
qiniu.conf.ACCESS_KEY = process.env.QINIU_DTCJ_AK;
qiniu.conf.SECRET_KEY = process.env.QINIU_DTCJ_SK;

function putToken(bucket) {
  var saveKey = 'sciuridae/assets/$(etag)';
